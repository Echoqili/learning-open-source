...
本 Skill 只在用户明确表达以下意图时激活；普通编码请求不触发，避免默认消耗大量 token：
...
- “规范流程”、“完整流程”、“完整走一遍”
- “思考模式”、“深度模式”、“认真设计”
- “快速模式”、“极速模式”、“省 token”、“简单做”、“fast mode”、“原型”
...
| 用户表达 | 进入模式 |
|----------|----------|
| “思考模式” / “完整流程” / “规范流程” / “深度模式” / “认真设计” | 思考模式（完整门禁） |
| “快速模式” / “极速模式” / “省 token” / “简单做” / “fast mode” / “原型” | 省 token 模式（精简门禁） |
| 仅说“Superpowers + OpenSpec 跑一遍” / “启动 change 流水线” / 提到 `/opsx:` 但未指定模式 | **默认进入省 token 模式** |

**核心原则**：只有用户明确要求“完整规范/深度思考”时才走很多门禁；默认触发走轻量流程。
...
本 Skill 提供两种互斥模式，由用户在触发时指定；未指定时默认进入**省 token 模式**，只有用户明确要求“完整规范/深度思考”时才进入思考模式。
...
> “帮我用 Superpowers + OpenSpec 跑一遍：用户登录后能看到自己的订单列表，支持按状态筛选。”
